...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['kids-r-us' . '_google_web_fonts']) && is_array($cmsmasters_option['kids-r-us' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['kids-r-us' . '_google_web_fonts'];
		...
		$fonts = array( 
			'' => esc_html__('None', 'kids-r-us'), 
			'local' => $local_fonts, 
			'web' => $google_web_fonts 
		);
		
		
		return apply_filters('kids_r_us_google_fonts_list_filter', $fonts);
	}
}
...
if (!function_exists('cmsmasters_text_transform_list')) {
	function cmsmasters_text_transform_list() {
		$list = array( 
			...
			'uppercase' => esc_html__('uppercase', 'kids-r-us'), 
			'lowercase' => esc_html__('lowercase', 'kids-r-us'), 
			'capitalize' => esc_html__('capitalize', 'kids-r-us'), 
		);
...
if (!function_exists('cmsmasters_image_thumbnail_list')) {
	function cmsmasters_image_thumbnail_list() {
		$list = kids_r_us_get_image_thumbnail_list();
...
if (!function_exists('cmsmasters_color_schemes_list')) {
	function cmsmasters_color_schemes_list() {
		$list = kids_r_us_all_color_schemes_list();
