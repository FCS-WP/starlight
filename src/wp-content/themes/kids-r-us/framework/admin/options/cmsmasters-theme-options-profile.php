...
if (!function_exists('kids_r_us_get_custom_profile_meta_fields')) {
function kids_r_us_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['kids-r-us' . '_profile_post_title']) && $cmsmasters_option['kids-r-us' . '_profile_post_title'] !== '') ? (($cmsmasters_option['kids-r-us' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['kids-r-us' . '_profile_post_details_title']) && $cmsmasters_option['kids-r-us' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['kids-r-us' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['kids-r-us' . '_profile_post_share_box']) && $cmsmasters_option['kids-r-us' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['kids-r-us' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'kids-r-us'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'kids-r-us'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'kids-r-us'), 
			'desc'	=> '', 
