...
if (!function_exists('kids_r_us_get_custom_project_meta_fields')) {
function kids_r_us_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['kids-r-us' . '_portfolio_project_title']) && $cmsmasters_option['kids-r-us' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['kids-r-us' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['kids-r-us' . '_portfolio_project_details_title']) && $cmsmasters_option['kids-r-us' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['kids-r-us' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['kids-r-us' . '_portfolio_project_share_box']) && $cmsmasters_option['kids-r-us' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['kids-r-us' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['kids-r-us' . '_portfolio_project_author_box']) && $cmsmasters_option['kids-r-us' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['kids-r-us' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['kids-r-us' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['kids-r-us' . '_portfolio_more_projects_box'] : 'related';
	
	$cmsmasters_proportion = kids_r_us_project_puzzle_proportion();
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'kids-r-us'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Project', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'kids-r-us'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'kids-r-us'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'kids-r-us'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'kids-r-us'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Project Title', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image Size', 'kids-r-us'), 
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio:', 'kids-r-us') . '</br>', 
			...
			'options' => array( 
				'one_x_one' => array( 
					...
					'size' => 'No Gap or 1px Gap - 480 x ' . ((int) (480 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 480 x ' . ((int) (480 * $cmsmasters_proportion - kids_r_us_project_puzzle_large_gar('one_x_one'))), 
					'label' => '1 x 1', 
					'value'	=> 'one_x_one' 
				), 
				'one_x_two' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/one_x_two.jpg', 
					'size' => 'No Gap or 1px Gap - 480 x ' . ((int) (960 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 480 x ' . kids_r_us_project_puzzle_large_gar('one_x_two'), 
					'label' => '1 x 2', 
					'value'	=> 'one_x_two' 
				), 
				'one_x_three' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/one_x_three.jpg', 
					'size' => 'No Gap or 1px Gap - 480 x ' . ((int) (1440 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 480 x ' . kids_r_us_project_puzzle_large_gar('one_x_three'), 
					'label' => '1 x 3', 
					'value'	=> 'one_x_three' 
				), 
				'two_x_one' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/two_x_one.jpg', 
					'size' => 'No Gap or 1px Gap - 960 x ' . ((int) (480 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 960 x ' . kids_r_us_project_puzzle_large_gar('two_x_one'), 
					'label' => '2 x 1', 
					'value'	=> 'two_x_one' 
				), 
				'two_x_two' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/two_x_two.jpg', 
					'size' => 'No Gap or 1px Gap - 960 x ' . ((int) (960 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 960 x ' . ((int) (960 * $cmsmasters_proportion - kids_r_us_project_puzzle_large_gar('two_x_two'))), 
					'label' => '2 x 2', 
					'value'	=> 'two_x_two' 
				), 
				'two_x_three' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/two_x_three.jpg', 
					'size' => 'No Gap or 1px Gap - 960 x ' . ((int) (1440 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 960 x ' . kids_r_us_project_puzzle_large_gar('two_x_three'), 
					'label' => '2 x 3', 
					'value'	=> 'two_x_three' 
				), 
				'three_x_one' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/three_x_one.jpg', 
					'size' => 'No Gap or 1px Gap - 1440 x ' . ((int) (480 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1440 x ' . kids_r_us_project_puzzle_large_gar('three_x_one'), 
					'label' => '3 x 1', 
					'value'	=> 'three_x_one' 
				), 
				'three_x_two' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/three_x_two.jpg', 
					'size' => 'No Gap or 1px Gap - 1440 x ' . ((int) (960 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1440 x ' . kids_r_us_project_puzzle_large_gar('three_x_two'), 
					'label' => '3 x 2', 
					'value'	=> 'three_x_two' 
				), 
				'three_x_three' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/three_x_three.jpg', 
					'size' => 'No Gap or 1px Gap - 1440 x ' . ((int) (1440 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1440 x ' . ((int) (1440 * $cmsmasters_proportion - kids_r_us_project_puzzle_large_gar('three_x_three'))), 
					'label' => '3 x 3', 
					'value'	=> 'three_x_three' 
				), 
				'four_x_four' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/four_x_four.jpg', 
					'size' => 'No Gap or 1px Gap - 1920 x ' . ((int) (1920 * $cmsmasters_proportion)) . '<br />' . 'Large Gap - 1920 x ' . ((int) (1920 * $cmsmasters_proportion - kids_r_us_project_puzzle_large_gar('four_x_four'))), 
					'label' => '4 x 4', 
					'value'	=> 'four_x_four' 
				) 
			) 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image (1px or No Gap)', 'kids-r-us'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects 1px or no gap', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image (Large Gap)', 'kids-r-us'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects large gap', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'kids-r-us'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'kids-r-us') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'kids-r-us'), 
			'desc'	=> esc_html__('Open link in a new tab', 'kids-r-us'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'kids-r-us'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'kids-r-us'), 
			'desc'	=> '', 
...
if (!function_exists('kids_r_us_project_puzzle_large_gar')) {

function kids_r_us_project_puzzle_large_gar($image_size = 'default') {
	$padding = '';
	
	$project_puzzle_large_gar_parameter = kids_r_us_project_puzzle_large_gar_parameters();
