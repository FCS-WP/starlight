...
if ($best == 'true') {
	if ($best_bg_color != '') {
		...
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_pricing_item_inner:after { ' . 
...
if ($button_show == 'true') {
	...
	if ($button_custom_styles == 'true') {
		...
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_button:after { ' . 
		...
		$this->pricing_table_items_atts['style_pricing'] .= '#cmsmasters_pricing_item_' . esc_attr($unique_id) . ' .cmsmasters_button:hover:after { ' . 
...
echo kids_r_us_return_content($price_out);
