...
<?php kids_r_us_get_header_search_form($cmsmasters_option); ?>

<!-- Start Page -->
<div id="page" class="<?php kids_r_us_get_page_classes($cmsmasters_option); ?>hfeed site">
...
<div id="middle">
<?php 
kids_r_us_page_heading();


list($cmsmasters_layout, $cmsmasters_page_scheme) = kids_r_us_theme_page_layout_scheme();
